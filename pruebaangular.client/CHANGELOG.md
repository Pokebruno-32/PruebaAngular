...
- Create Angular project with ng: `ng new pruebaangular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`pruebaangular.client.esproj`).
